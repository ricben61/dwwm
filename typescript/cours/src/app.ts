...
// console.log(bocar,jerome);
// console.log(jerome.register());

//   -----implementation interface----
/// "implements" c'est pour un heritage pour interface
///  "extends"  c'est pour un heritage de class
...
class Salarie extends User{
        ...
        constructor (id: number, pseudo:string, role:string){
